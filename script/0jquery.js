...
*/ (function (e, t) {
  ...
  b.fn = b.prototype = {
      ...
      if ("string" == typeof e) {
        ...
        if (i[1]) {
          if (
            ...
            for (i in n) {b.isFunction(this[i]) ? this[i](n[i])
              : this.attr(i, n[i]);}
          }
          return this;
        }
    ...
    b.extend({
      ...
      each: function (e, t, n) {
        ...
        if (n) {
          if (a) for (; o > i; i++) if (r = t.apply(e[i], n), r === !1) break;
  ...
  b.Callbacks = function (e) {
    ...
    b.extend({
      Deferred: function (e) {
        var t = [["resolve", "done", b.Callbacks("once memory"), "resolved"], [
            "reject",
            "fail",
    ...
    b.support = function () {
      ...
      a = o.createElement("input"),
        ...
        d.attachEvent && (d.attachEvent("onclick", function () {
          ...
          d.cloneNode(!0).click());
      for (
        f in { submit: !0, change: !0, focusin: !0 }
      ) {
    ...
    function (e, t) {
      var n,
        ...
        tt = function (e, t) {
          var n = "0x" + t - 65536;
          return n !== n ? t
          : 0 > n ? String.fromCharCode(n + 65536)
            ...
            ? (p = n,
              ...
              v = f.compareDocumentPosition
                ...
                : function (e, t) {
                  ...
                  while (s[i] === l[i]) i++;
                  return i ? ut(s[i], l[i]) : s[i] === w ? -1 : l[i] === w
                    ? 1
                    : 0;
                },
              u = !1,
        ...
        if (
          h.promise(N).complete = g.add,
            ...
            (r = En.exec(p.url.toLowerCase()),
              p.crossDomain =
                !(!r ||
                  r[1] === mn[1] && r[2] === mn[2] && (r[3] || ("http:" === r[1]
                        ? 80
                        : 443)) == (mn[3] || ("http:" === mn[1] ? 80 : 443)))),
  ...
  b.Tween = rr,
    ...
    rr.propHooks = {
      _default: {
        ...
        set: function (e) {
          b.fx.step[e.prop] ? b.fx.step[e.prop](e)
          : e.elem.style &&
